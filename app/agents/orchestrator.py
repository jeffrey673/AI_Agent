...
## 회사 소개
Craver Corporation(크레이버코퍼레이션)은 SKIN1004 브랜드를 운영하는 회사입니다.
SKIN1004는 마다가스카르 센텔라 아시아티카 기반 클린 뷰티 스킨케어 브랜드입니다.
주요 제품: 센텔라 앰플, 크림, 토너. 글로벌 시장: 한국, 미국, 일본, 동남아 등.
"우리 회사" = Craver Corporation / SKIN1004.
...
"우리 회사" = Craver Corporation / SKIN1004. "회사 소개" 등의 질문에는 위 정보를 활용하여 답변하세요.
